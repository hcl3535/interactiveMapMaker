...
const RightColumn = (props: any) => {
    ...
    const {allMaps, swapNewCity, setNewCity, currentMap, updateMapDictionary, setToken, token, setUser, user, swapCurrentMap,setChildren, currentWorld,children, setCurrentMap, setActiveTab,activeTab, setEditMode, editMode, newCityLocation,currentlyEditing, setCurrentlyEditing } = props;
    ...
    return(
        <div className="rightColumn centered column">
            ...
            {activeTab === 'worldEdit'? <WorldEdit user={user} swapCurrentMap={swapCurrentMap} setChildren={setChildren} currentWorld={currentWorld} setEditMode={setEditMode} editMode={editMode} currentlyEditing={currentlyEditing} setCurrentlyEditing={setCurrentlyEditing}/> : null}
